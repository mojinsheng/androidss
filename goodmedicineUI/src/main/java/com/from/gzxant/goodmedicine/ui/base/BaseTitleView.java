...
public abstract class BaseTitleView extends BaseRelativeLayout{
	...
	private void init(Context context){
		...
		RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams(getBackSize()[0], getBackSize()[1]);
		...
		params = new RelativeLayout.LayoutParams(getTitleSize()[0], getTitleSize()[1]);
...
//
		...
		params = new RelativeLayout.LayoutParams(getSetSize()[0], getSetSize()[1]);
		params.addRule(RelativeLayout.CENTER_VERTICAL);
